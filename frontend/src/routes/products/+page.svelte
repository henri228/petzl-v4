      ...
      <tbody>
        {#each filteredProducts as product, i}
          ...
          >
            ...
            <td class="px-4 py-2">{(product.discountMax * 100).toFixed(0)}%</td>
            <td class="px-4 py-2">{(product.discountAvg * 100).toFixed(0)}%</td>
            <td class="px-4 py-2">
              <a href="product/{product.ean}" class="text-orange-800">Details</a
              >
            </td>
          </tr>
        {/each}
