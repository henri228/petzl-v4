...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="${"flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8"}"><div class="${"mt-8 sm:mx-auto sm:w-full sm:max-w-md"}"><div class="${"bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10"}"><div class="${"sm:mx-auto sm:w-full sm:max-w-md"}"><a href="${"/"}"><img class="${"mx-auto h-12 w-auto"}" src="${"https://upload.wikimedia.org/wikipedia/fr/c/c4/Logo_Petzl.svg"}" alt="${"Your Company"}"></a>
      ...
      <form class="${"space-y-6"}" action="${"?/register"}" method="${"POST"}"><div><label for="${"email"}" class="${"block text-sm font-medium text-gray-700"}">Email</label>
        ...
        <div><button type="${"submit"}" class="${"flex w-full justify-center rounded-md border border-transparent bg-black py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-pink-700 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-offset-2"}">Register</button></div>
